...
public abstract class ReflectionUtils {
	...
	public static <E> E newInstance(Class<E> clazz) {
		...
		try {
			...
			throw new BaseException("Create instance is error of class is : " + clazz.getName());
		}
	}
	...
	public static Object invokeMethod(Object obj, Method method, Object...args) {
		...
		try {
			...
			throw new BaseException("Invoke method is error of method is : " + method.getName());
		}
	}
	...
	public static void setFieldValue(Object obj, Field field, Object value) {
		...
		try {
			...
			throw new BaseException("Set field value is error of field is : " + field.getName());
		}
	}
